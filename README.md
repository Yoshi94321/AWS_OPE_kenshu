...
セキュアな運用環境を構築する演習。 [研修資料 vol.1](AWS_OPE_Kenshu_vol.1.pdf)
...
低レイテンシかつセキュアに配信する構成を設計・構築する演習。 [研修資料 vol.2](AWS_OPE_Kenshu_vol.2.pdf)
...
Auto Scaling・監視・通知までを含めた運用を自動化する演習。 [研修資料 vol.3](AWS_OPE_Kenshu_vol.3.pdf)
